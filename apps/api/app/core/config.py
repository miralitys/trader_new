...
class Settings(BaseSettings):
    ...
    nightly_validation_enabled: bool = Field(default=True, alias="NIGHTLY_VALIDATION_ENABLED")
    nightly_validation_timezone: str = Field(default="America/Chicago", alias="NIGHTLY_VALIDATION_TIMEZONE")
    nightly_validation_hour: int = Field(default=2, alias="NIGHTLY_VALIDATION_HOUR")
    ...
    weekly_deep_validation_enabled: bool = Field(default=True, alias="WEEKLY_DEEP_VALIDATION_ENABLED")
    weekly_deep_validation_timezone: str = Field(default="America/Chicago", alias="WEEKLY_DEEP_VALIDATION_TIMEZONE")
    weekly_deep_validation_hour: int = Field(default=5, alias="WEEKLY_DEEP_VALIDATION_HOUR")
    weekly_deep_validation_minute: int = Field(default=0, alias="WEEKLY_DEEP_VALIDATION_MINUTE")
    weekly_deep_validation_weekday: str = Field(default="FRI", alias="WEEKLY_DEEP_VALIDATION_WEEKDAY")
    weekly_deep_validation_lookback_days: int = Field(default=7, alias="WEEKLY_DEEP_VALIDATION_LOOKBACK_DAYS")
    weekly_deep_validation_sample_limit: int = Field(default=5, alias="WEEKLY_DEEP_VALIDATION_SAMPLE_LIMIT")
    weekly_deep_validation_resync_days: int = Field(default=7, alias="WEEKLY_DEEP_VALIDATION_RESYNC_DAYS")
